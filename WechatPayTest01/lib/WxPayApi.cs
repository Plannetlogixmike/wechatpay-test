...
using System.IO;
using System.Text;
using WechatPayTest01.viewmodels;

namespace WechatPayTest01.lib
{
    public class WxPayApi
    {
        static string _url_quickpay;
        static string _url_orderquery;
        static string _url_downloadbills;
        static string _url_refund;
        static string _url_refundquery;
        static string _url_cancelpay;
        static string _terminal_ip;
        static string _publicaccountid;
        static string _venderid;
        static string _appsecred;
        static string _key;
        ...
        {
            get { return _terminal_ip; }
            set
            {
                _terminal_ip = value;
            }
        }
        public static string Public_Account_ID
        {
        ...
        public static string App_Secred
        {
        ...
        public static string URL_CancelPay
        {
            get { return _url_cancelpay; }
            set
            {
                _url_cancelpay = value;
            }
        }

        public static string URL_Refund
        {
            get { return _url_refund; }
            set
            {
                _url_refund = value;
            }
        ...
        public static string URL_RefundQuery
        {
            get { return _url_refundquery; }
            set
            {
                _url_refundquery = value;
            }
        }

        public static string URL_DownloadBills
        {
            get { return _url_downloadbills; }
            set
            {
                _url_downloadbills = value;
            }
        }

        public static string URL_QuickPay
        {
            get { return _url_quickpay; }
            set
            {
                _url_quickpay = value;
            }
        ...
        {
            get { return _url_orderquery; }
            set
            {
                _url_orderquery = value;
            }
        }
...
//            Log.Debug("WxPayApi", "MicroPay request : " + xml);
            string response = HttpService.Post(xml, _url_quickpay, false, timeOut);//调用HTTP通信接口以提交数据到API
//            Log.Debug("WxPayApi", "MicroPay response : " + response);
            ...
            ReportCostTime(_url_quickpay, timeCost, result);//测速上报
...
//            Log.Debug("WxPayApi", "OrderQuery response : " + response);
            ...
            ReportCostTime(_url_orderquery, timeCost, result);//测速上报
...
//            string url = "https://api.mch.weixin.qq.com/secapi/pay/reverse";
            ...
            string response = HttpService.Post(xml, _url_cancelpay, true, timeOut);
            ...
            ReportCostTime(_url_cancelpay, timeCost, result);//测速上报
...
//            string url = "https://api.mch.weixin.qq.com/secapi/pay/refund";
            ...
            string response = HttpService.Post(xml, _url_refund, true, timeOut);//调用HTTP通信接口提交数据到API
            ...
            ReportCostTime(_url_refund, timeCost, result);//测速上报
...
//		    string url = "https://api.mch.weixin.qq.com/pay/refundquery";
            ...
            string response = HttpService.Post(xml, _url_refundquery, false, timeOut);//调用HTTP通信接口以提交数据到API
		    ...
		    ReportCostTime(_url_refundquery, timeCost, result);//测速上报
...
//            string url = "https://api.mch.weixin.qq.com/pay/downloadbill";
            ...
            string response = HttpService.Post(xml, _url_downloadbills, false, timeOut);//调用HTTP通信接口以提交数据到API
	    ...
	    * @return 成功时返回，其他抛异常
	    */
	    public static WxPayData CloseOrder(WxPayData inputObj, string url, int timeOut = 6)
	    {
//		    string url = "https://api.mch.weixin.qq.com/pay/closeorder";
	    ...
	    */
        ...
        public static string GetSignKey()
        {
            ...
            //            object signKey;
            if (result.IsSet("sandbox_signkey"))
                return result.GetValue("sandbox_signkey").ToString();
     ...
     // original code
//            SortedDictionary<string, object> items = FromXmlToDictionary(response);
